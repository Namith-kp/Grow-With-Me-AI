...
export const SettingsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 0 2.82l-.15.1a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1 0-2.82l.15-.1a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><circle cx="12" cy="12" r="3"></circle></svg>
);
...
export const LightbulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-7 7c0 3.03 1.09 5.25 3 7h8c1.91-1.75 3-3.97 3-7a7 7 0 0 0-7-7z"></path></svg>
);
...
export const RocketIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.1S5.21 15.66 4.5 16.5z"></path><path d="M7.5 12.5c0-1.5-1.14-2.5-2.5-3S3.5 6.5 3.5 5c0-1.5 1.14-2.5 2.5-3S8.5 3.5 8.5 5c0 1.5-1.14 2.5-2.5 3S3.5 9.5 3.5 11"></path><path d="M14.5 6.5c1.5-1.26 2-5 2-5s-3.74.5-5 2c-.71.84-.7 2.3-.05 3.1s1.34 1.25 2.05 1.4z"></path><path d="M16.5 11.5c0 1.5 1.14 2.5 2.5 3s1.5 2.5 1.5 4c0 1.5-1.14 2.5-2.5 3s-2.5-1.5-2.5-3c0-1.5 1.14-2.5 2.5-3s1.5-2.5 1.5-4"></path><path d="M13 10.29V5a2 2 0 0 1 2-2h4"></path><path d="m5 19 4-4"></path></svg>
);
...
export const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a2.5 2.5 0 0 0-2.5 2.5v.7a1 1 0 0 1-1.2.9L7.2 6.3a2.5 2.5 0 1 0-2.9 4.4l1.3 1.6a1 1 0 0 1 0 1.4l-1.3 1.6a2.5 2.5 0 1 0 2.9 4.4l1.1-.8a1 1 0 0 1 1.2.9v.7a2.5 2.5 0 1 0 5 0v-.7a1 1 0 0 1 1.2-.9l1.1.8a2.5 2.5 0 1 0 2.9-4.4l-1.3-1.6a1 1 0 0 1 0-1.4l1.3-1.6a2.5 2.5 0 1 0-2.9-4.4l-1.1.8a1 1 0 0 1-1.2-.9v-.7A2.5 2.5 0 0 0 12 2zM4.5 12.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM19.5 12.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM12 21.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM12 4.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"></path></svg>
);
...
export const BullseyeIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const CheckCheckIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 6 7 17l-5-5"></path><path d="m22 10-7.5 7.5L13 16"></path></svg>
);
...
/* Removed duplicate icons that already exist */
...
export const GithubIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-1.94-2.61c-.63-.38-1.29-.59-1.97-.59-.47 0-1.93.2-1.93.2s-.47-.2-1.93-.2c-.68 0-1.34.21-1.97.59A3.37 3.37 0 0 0 9 16.13V19m0-16c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-1.94-2.61c-.63-.38-1.29-.59-1.97-.59-.47 0-1.93.2-1.93.2s-.47-.2-1.93-.2c-.68 0-1.34.21-1.97.59A3.37 3.37 0 0 0 9 3.13V6m0-3c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-1.94-2.61c-.63-.38-1.29-.59-1.97-.59-.47 0-1.93.2-1.93.2s-.47-.2-1.93-.2c-.68 0-1.34.21-1.97.59A3.37 3.37 0 0 0 9 3.13V6"></path></svg>
);
